...
<body>
    ...
    <main>
        <div class="mt-5 container mx-auto">
                                ...
                                <div class="border-t border-gray-200">
                                    <div class="p-10">
                                        ...
                                        <div class="flex items-center grid-cols-6 gap-4">
                                            <label for="L_Size" class="col-span-2 sm:col-span-2">敷地面積</label>

                                            <input type="number" step="0.01"
                                                class="w-1/3 ml-auto form-input border-2 border-blue-500 rounded-lg text-center"
                                                id="L_Size" placeholder="例:100" />

                                            <label for="L_Size" class="col-span-2 sm:col-span-2">㎡　</label>
                                        </div>

                                        <!-- 路線価 -->
                                        <div class="flex items-center grid-cols-6 gap-4 mt-5">
                                            <label for="L_RTR" class="col-span-2 sm:col-span-2">路線価</label>

                                            <input type="number" step="0.01"
                                                class="w-1/3 ml-auto form-input border-2 border-blue-500 rounded-lg text-center"
                                                id="L_RTRe" placeholder="例:100" />

                                            <label for="L_RTR" class="">千円</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="collapseTwo" class="collapse show" role="tabpanel" aria-labelledby="headingTwo">
                                <div class="card-body">
                                    ...
                                    <div class="border-t p-10">
                                        ...
                                        <!-- 建物構造 -->
                                        <div class="flex items-center grid-cols-6 gap-4 mt-5">
                                            <label for="B_Type" class="col-span-2 sm:col-span-2">建物構造</label>
                                        ...
                                        <!-- 築年数 -->
                                        <div class="flex items-center grid-cols-6 gap-4 mt-5">
                                            <label for="B_Age" class="col-span-5 sm:col-span-2">築年数</label>

                                            <input type="number"
                                                class="w-1/3 ml-auto form-input border-2 border-blue-500 rounded-lg text-center"
                                                id="B_Age" placeholder="" value="">

                                            <label for="B_Age" class="col-span-2 sm:col-span-2">年　</label>
                                        </div>
                                        <!-- 標準建築費 -->
                                        <div class="flex items-center grid-cols-6 gap-4 mt-5">
                                            <label for="B_Cost" class="col-span-5 sm:col-span-2">標準建築費</label>

                                            <input type="number"
                                                class="w-1/3 ml-auto form-input border-2 border-blue-500 rounded-lg text-center bg-gray-200"
                                                id="B_Cost" placeholder="" step="" readonly="readonly">

                                            <label for="B_Cost" class="col-span-2 sm:col-span-2">万円</label>
                                        </div>
                                        <!--耐用年数-->
                                        <div class="flex items-center grid-cols-6 gap-4 mt-5">
                                            <label for="B_Life" class="col-span-5 sm:col-span-2">耐用年数</label>

                                            <input type="number"
                                                class="w-1/3 ml-auto form-input border-2 border-blue-500 rounded-lg text-center bg-gray-200"
                                                id="B_Life" placeholder="" step="1.0" value=""
                                                readonly="readonly" />

                                            <label for="B_Life" class="col-span-2 sm:col-span-2">年　</label>
                                        </div>
                                    </div>
                                    <!-- 縦幅の調整 -->
                        ...
                        <div id="collapseThree" class="collapse show" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="card-body p-10">
                                <div class="flex flex-wrap mb-0">
                                    ...
                                    <label class="w-1/2 sm:w-1/3 pl-0 pt-0 pb-0 text-right" id="lbl_B_Size"></label>
                                </div>
                                ...
                                <div class="flex flex-wrap mb-0">
                                    ...
                                    <label class="w-1/2 sm:w-1/3 pl-0 pt-0 pb-0 text-right" id="lbl_B_Type"></label>
                                </div>

                                <div class="flex flex-wrap mb-0">
                                    <label class="w-1/2 sm:w-1/3 pr-0 pt-0 pb-0 text-left">築年数</label>
                                    <label class="w-1/2 sm:w-1/3 pl-0 pt-0 pb-0 text-right" id="lbl_B_age"></label>
                                </div>

                                <div class="flex flex-wrap mb-0">
                                    <label class="w-1/2 sm:w-1/3 pr-0 pt-0 pb-0 text-left">標準建築費</label>
                                    <label class="w-1/2 sm:w-1/3 pl-0 pt-0 pb-0 text-right" id="lbl_B_Cost"></label>
                                </div>

                                <div class="flex flex-wrap mb-0">
                                    <label class="w-1/2 sm:w-1/3 pr-0 pt-0 pb-0 text-left">耐用年数</label>
                                    <label class="w-1/2 sm:w-1/3 pl-0 pt-0 pb-0 text-right" id="lbl_B_Life"></label>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <script>
                function resetForm() {
                    document.forms["SekisanForm"].reset();
                }
            </script>
    ...
    <script type="" src="{{ asset('/js/calculate_test.js') }}"></script>
</body>
